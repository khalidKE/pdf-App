  ...
  List<Feature> _getFeatures(BuildContext context) {
    ...
    return [
      ...
      Feature(
        ...
        description: loc.translate('Convert text to PDF'),
      ...
      Feature(
        title: loc.translate('QR & Barcodes'),
        description: loc.translate('Create and scan codes'),
        icon: Icons.qr_code,
      ...
      Feature(
        ...
        description: loc.translate('Convert Excel files to PDF'),
      ...
      Feature(
        ...
        description: loc.translate('Convert Word files to PDF'),
      ...
      Feature(
        ...
        description: loc.translate('Combine multiple PDF files'),
      ...
      Feature(
        ...
        description: loc.translate('Divide PDF into parts'),
      ...
      Feature(
        ...
        description: loc.translate('Add watermark to PDF'),
      ...
      Feature(
        ...
        description: loc.translate('Sign PDF with drawing'),
        icon: Icons.draw,
        color: AppConstants.secondaryColor,
      ...
      Feature(
        ...
        description: loc.translate('Extract text from PDF or image'),
      ...
      Feature(
        title: loc.translate('View Files'),
        description: loc.translate('Browse files on device'),
