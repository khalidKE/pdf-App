...
class _ExcelToPdfScreenState extends State<ExcelToPdfScreen>
  ...
  Future<void> _addSheetToPdf(pw.Document pdf, String sheetName,
      List<List<String>> rows, pw.Font font) async {
                    ...
                    children: chunk.map((row) {
                      ...
                      return pw.TableRow(
                        ...
                        children: _buildTableCells(
                            row, maxColumns, isHeaderRow, font),
                      );
                    }).toList(),
                  ),
                ),
  ...
  List<pw.Widget> _buildTableCells(
    ...
    for (int i = 0; i < maxColumns; i++) {
      ...
      final textDirection =
          isRtl(cellValue) ? pw.TextDirection.rtl : pw.TextDirection.ltr;
